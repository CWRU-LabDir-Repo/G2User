...
# -*- coding: utf-8 -*-
"""
Copied on Thur Mar 7, 2024
Code to create the daily plots of Freq shift / Signal Amplitude
03-07-2024 Ver 0.10 - first attempt at Grape 2 plotting
...
#-------------------------------------------------
#-------------------------------------------------
print('Grape 2 Plotting Program Ver ' + PlotVers)
print('***********************************\n')
...
File2Plot = HomePath + '/PSWS/Scmd/f2t.txt'
print('File2Plot = ' + File2Plot)
...
XferDataDir = HomePath + '/G2DATA/Sxfer/'
...
if (path.exists(File2Plot)):
    print('Files to plot file exists: ' + File2Plot)
else:
    print('Exiting - No directory ', File2Plot)
    sys.exit(0)
...
# look for existance of  file
# make sure temp path exists - if not, abort
if (path.exists(File2Plot)):
    print('Plot File list exists: ' + File2Plot)
else:
    print('No File list - exiting mad! ', File2Plot)
    sys.exit(0)
...
with open(File2PLot, 'r') as ToDoFile:
    print('\n\n**************************************************')
    print('**************************************************')
